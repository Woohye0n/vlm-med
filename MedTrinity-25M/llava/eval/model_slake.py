...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/workspace/vlm-med/MedTrinity-25M/llava-llama-med-8b-stage2-finetune-slake_orift")
    # parser.add_argument("--model-path", type=str, default="/workspace/vlm-med/MedTrinity-25M/llava-llama-med-8b-stage2-finetune-pathvqa_orift")
    # parser.add_argument("--model-path", type=str, default="/workspace/vlm-med/MedTrinity-25M/llava-llama-med-8b-stage2-finetune-vqa_rad_orift")
