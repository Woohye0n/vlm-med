...
root_dir = '../mvtec_dataset/mvtec_anomaly_detection'
...
for c_name in CLASS_NAMES:
    normal_img_paths = ["../mvtec_dataset/mvtec_anomaly_detection/"+c_name+"/train/good/"+str(command_args.round * 4).zfill(3)+".png", "../mvtec_dataset/mvtec_anomaly_detection/"+c_name+"/train/good/"+str(command_args.round * 4 + 1).zfill(3)+".png",
                        "../mvtec_dataset/mvtec_anomaly_detection/"+c_name+"/train/good/"+str(command_args.round * 4 + 2).zfill(3)+".png", "../mvtec_dataset/mvtec_anomaly_detection/"+c_name+"/train/good/"+str(command_args.round * 4 + 3).zfill(3)+".png"]
